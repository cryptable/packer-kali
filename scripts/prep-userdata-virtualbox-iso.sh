...
cat <<EOF > ./http/virtualbox/linux/kali/2021.4a/preseed.cfg
...
# Install packages
# Verify what to use on: https://www.kali.org/tools/kali-meta/
tasksel tasksel/first multiselect standard
d-i pkgsel/include string openssh-server kali-linux-default kali-desktop-xfce
